...
int main()
{
	...
	if (abs(x1 - x2) == abs(y1 - y2)) {
		...
		cout << "Для того, чтоб попасть из первого поля во второе за два хода слона, первый ход должен привести на поле с кооридинатами : ";
		if ((a1 < 9) and (a1 > 0) and (b1 > 0) and (b1 < 9)) {//проверка на нахождение полей на доске
			cout << " (" << a1 << ", " << b1 << ") ";

		}
		if ((a2 < 9) and (a2 > 0) and (b2 > 0) and (b2 < 9)) {
			cout << " (" << a2 << ", " << b2 << ") ";
